...
<main class="main">
            ...
            <div class="section-title">
                <div class="title">
                    ...
                    <ul class="list-inline nav nav-tabs links">
                        ...
                        <li class="list-inline-item nav-item"><a class="nav-link"  href=" {{ asset('shop-grid-right.html') }}">Cake & Milk</a></li>
                        <li class="list-inline-item nav-item"><a class="nav-link"   href=" {{ asset('shop-grid-right.html') }}">Coffes & Teas</a></li>
                        <li class="list-inline-item nav-item"><a class="nav-link active"   href=" {{ asset('shop-grid-right.html') }}">Pet Foods</a></li>
                        <li class="list-inline-item nav-item"><a class="nav-link"   href=" {{ asset('shop-grid-right.html') }}">Vegetables</a></li>
                    </ul>
                </div>
                ...
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">     
                            ...
                            <a   href=" {{ asset('shop-grid-right.html') }}"><img src= "{{URL::asset('assets/imgs/shop/cat-13.png')}}"  alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Cake & Milk</a></h6>
                        <span>26 items</span>
                    </div>
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                          
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src=  "{{URL::asset('assets/imgs/shop/cat-12.png')}}"  alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Oganic Kiwi</a></h6>
                        <span>28 items</span>
                    </div>
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                          
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src="{{URL::asset('assets/imgs/shop/cat-11.png')}}"  alt="" /></a>
                        </figure>
                       
                        <h6><a  href=" {{ asset('shop-grid-right.html') }}">Peach</a></h6>
                        <span>14 items</span>
                    </div>
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            
                            <a  href=" {{ asset('shop-grid-right.html') }}"><img src="{{URL::asset('assets/imgs/shop/cat-9.png')}}" alt="" /></a>
                        </figure>
                        <h6><a  href=" {{ asset('shop-grid-right.html') }}">Red Apple</a></h6>
                        <span>54 items</span>
                    </div>
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                           
                            <a  href=" {{ asset('shop-grid-right.html') }}"><img src=  "{{URL::asset('assets/imgs/shop/cat-3.png')}}" alt="" /></a>
                        </figure>
                        <h6><a  href=" {{ asset('shop-grid-right.html') }}">Snack</a></h6>
                        <span>56 items</span>
                    </div>
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a  href=" {{ asset('shop-grid-right.html') }}"><img src= "{{URL::asset('assets/imgs/shop/cat-1.png')}}" alt="" /></a>
                        </figure>
                        <h6><a  href=" {{ asset('shop-grid-right.html') }}">Vegetables</a></h6>
                        <span>72 items</span>
                    </div>
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src="{{URL::asset('assets/imgs/shop/cat-2.png')}}" alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Strawberry</a></h6>
                        <span>36 items</span>
                    </div>
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src= "{{URL::asset('assets/imgs/shop/cat-4.png')}}" alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Black plum</a></h6>
                        <span>123 items</span>
                    </div>
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src="{{URL::asset('assets/imgs/shop/cat-5.png')}}" alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Custard apple</a></h6>
                        <span>34 items</span>
                    </div>
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                           
                            <a hhref=" {{ asset('shop-grid-right.html') }}"><img src= "{{URL::asset('assets/imgs/shop/cat-14.png')}}" alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Coffe & Tea</a></h6>
                        <span>89 items</span>
                    </div>
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                        <figure class="img-hover-scale overflow-hidden">
                          
                            <a href=" {{ asset('shop-grid-right.html') }}"><img src=  "{{URL::asset('assets/imgs/shop/cat-15.png')}}" alt="" /></a>
                        </figure>
                        <h6><a href=" {{ asset('shop-grid-right.html') }}">Headphone</a></h6>
                        <span>87 items</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        ...
                        <img src="{{URL::asset('assets/imgs/banner/banner-1.png')}}" alt="" />
                        <div class="banner-text">
                            <h4>
                                Everyday Fresh & <br />Clean with Our<br />
                                Products
                            </h4>
                            <a href=" {{ asset('shop-grid-right.html') }}" class="btn btn-xs">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        ...
                        <img src="{{URL::asset('assets/imgs/banner/banner-2.png')}}" alt="" />
                        <div class="banner-text">
                            <h4>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img mb-sm-0 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        ...
                        <img src="{{URL::asset('assets/imgs/banner/banner-3.png')}}" alt="" />
                        <div class="banner-text">
                    ...
                    <div class="row product-grid-4">
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href=" {{ asset('shop-product-right.html') }}">
                                            
                                            <img class="default-img" src= "{{URL::asset('assets/imgs/shop/product-1-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-1-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                      
                                        <a aria-label="Add To Wishlist" class="action-btn"  href=" {{ asset('shop-wishlist.html') }}"><i class="fi-rs-heart"></i></a>
                                        <a aria-label="Compare" class="action-btn" href=" {{ asset('shop-compare.html') }}"><i class="fi-rs-shuffle"></i></a>
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        ...
                                        <a  href=" {{ asset('shop-grid-right.html') }}">Snack</a>
                                    </div>
                                    ...
                                    <div>
                                        <span class="font-small text-muted">By <a  href=" {{ asset('vendor-details-1.html') }}">NestFood</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        ...
                                        <div class="add-cart">
                                            ...
                                            <a class="add"  href=" {{ asset('shop-cart.html') }}"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href=" {{ asset('shop-product-right.html') }}">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-2-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-2-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        ...
                                        <a href=" {{ asset('shop-grid-right.html') }}">Hodo Foods</a>
                                    </div>
                                    <h2><a  href=" {{ asset('shop-product-right.html') }}">All Natural Italian-Style Chicken Meatballs</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-small text-muted">By <a  href=" {{ asset('vendor-details-1.html') }}">Stouffer</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>$52.85</span>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a  href=" {{ asset('shop-product-right.html') }}">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-3-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-3-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href=" {{ asset('shop-product-right.html') }}">Angie’s Boomchickapop Sweet & Salty Kettle Corn</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-small text-muted">By <a  href=" {{ asset('vendor-details-1.html') }}">StarKist</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>$48.85</span>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a h href=" {{ asset('shop-product-right.html') }}">
                                           
                                            <img class="default-img"  src="{{URL::asset('assets/imgs/shop/product-4-1.jpg')}}" alt="" />
                                            <img class="hover-img"  src="{{URL::asset('assets/imgs/shop/product-4-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img"   src="{{URL::asset('assets/imgs/shop/product-5-1.jpg')}}" alt="" />
                                            <img class="hover-img"src="{{URL::asset('assets/imgs/shop/product-5-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img"  src="{{URL::asset('assets/imgs/shop/product-6-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-6-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-7-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-7-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img"  src="{{URL::asset('assets/imgs/shop/product-8-1.jpg')}}" alt="" />
                                            <img class="hover-img"  src="{{URL::asset('assets/imgs/shop/product-8-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img"  src="{{URL::asset('assets/imgs/shop/product-9-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-9-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-10-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-10-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-12-1.jpg')}}" alt="" />
                                            <img class="hover-img"  src="{{URL::asset('assets/imgs/shop/product-12-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img"  src="{{URL::asset('assets/imgs/shop/product-13-1.jpg')}}" alt="" />
                                            <img class="hover-img"  src="{{URL::asset('assets/imgs/shop/product-13-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-14-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-14-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-15-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-15-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            ...
                                            <img class="default-img" src="{{URL::asset('assets/imgs/shop/product-16-1.jpg')}}" alt="" />
                                            <img class="hover-img" src="{{URL::asset('assets/imgs/shop/product-16-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href="shop-product-right.html">
                                    ...
                                    <img  src="{{URL::asset('assets/imgs/banner/banner-5.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href="shop-product-right.html">
                                    ...
                                    <img src="{{URL::asset('assets/imgs/banner/banner-6.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href="shop-product-right.html">
                                    ...
                                    <img src="{{URL::asset('assets/imgs/banner/banner-7.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href="shop-product-right.html">
                                    ...
                                    <img   src="{{URL::asset('assets/imgs/banner/banner-8.png')}}" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-1.jpg')}}" alt="" /></a>
                            </figure>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img   src="{{URL::asset('assets/imgs/shop/thumbnail-2.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                                    <a href="shop-product-right.html">Nestle Original Coffee-Mate Coffee Creamer</a>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-3.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                                    <a href="shop-product-right.html">Nestle Original Coffee-Mate Coffee Creamer</a>
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-4.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-5.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-6.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img   src="{{URL::asset('assets/imgs/shop/thumbnail-7.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-8.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img  src="{{URL::asset('assets/imgs/shop/thumbnail-9.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                ...
                                <a href="shop-product-right.html"><img src="{{URL::asset('assets/imgs/shop/thumbnail-10.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
    ...
    <input type="text" id="test" value="nadeesha">
    <!--End 4 columns-->
</main>
