          ...
          <div class="row">
           ...
           <div class="row mt-3">
             ...
             <label>Description</label>
              <textarea class="multisteps-form__input form-control" type="text" placeholder="eg. 42" ></textarea>
               <div class="button-row d-flex mt-4">
                <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button" title="Next">Create</button>
              </div>
            </div>  
           </div>
         </div>
