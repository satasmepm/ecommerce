  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        <img src="../img/dologo.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">do</span>
      </a>
    </div>
      ...
      <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="text-white opacity-5" href="javascript:;">Admin</a></li>
            <li class="breadcrumb-item text-sm" aria-current="page">Category</li>
          </ol>
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="../img/imgcat.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
  ...
  <div class="container-fluid py-4">
      <div class="row">
       <div class="float-md-left">
         <form class="multisteps-form__form mb-8" action="{{ route('ajaxImageUpload') }}" enctype="multipart/form-data" method="POST" id="create_category">
           @csrf
       ...
       <div class="row mt-3">
         <div class="col-12 col-sm-12">
          <label>Category</label>
           <input class="multisteps-form__input form-control" type="text" placeholder="eg. Off-White" name="categoryname" />

         <label>Description</label>
          <textarea class="multisteps-form__input form-control" type="text" name="description" placeholder="eg. 42" ></textarea>
          ...
          <div class="mb-3">
           ...
           <div class="button-row d-flex mt-4">
            <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next upload-image" id="create_category" type="button" title="Next">Create</button>
          </div>
        </div>  
       </div>
     </div>
...
<div class="modal fade" id="edit_category_details" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  $('body').on('click','.delete',function(){
    ...
    $('#create_category').click(function(){
      ...
      var create_category_ajax = new FormData(create_category);
