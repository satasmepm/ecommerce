              ...
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Todays Users</p>
                        <h5 class="font-weight-bolder mb-0">
                          2,300
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                      <div class="bg-gradient-primary border-radius-lg h-100">
                        <img src="{{URL::asset('../img/shapes/waves-white.svg')}}" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                        <div class="position-relative d-flex align-items-center justify-content-center h-100">
                          <img class="w-100 position-relative z-index-2 pt-4" src="{{URL::asset('../img/illustrations/rocket-white.png')}}" alt="rocket">
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                ...
                                <img src="{{URL::asset('../img/small-logos/logo-xd.svg')}}" class="avatar avatar-sm me-3" alt="xd">
                              </div>
                              <div class="d-flex flex-column justify-content-center">
